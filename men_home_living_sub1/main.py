...
# Hardcoded subcategory URLs for Men's Home & Living
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/home-living/travel-outdoor/l/",
    "https://www.boutiqaat.com/ar-kw/men/home-living/dcor-accessories/l/",
    "https://www.boutiqaat.com/ar-kw/men/home-living/kitchen-dining/l/",
    "https://www.boutiqaat.com/ar-kw/men/home-living/drinkware/l/",
    "https://www.boutiqaat.com/ar-kw/men/home-living/books-stationary-360214326/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Home & Living Pipeline (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/home-living/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/home-living/excel-files"
            )
